...
/**
 * Appstate for saving screenshot of 3d view
 * 
 * @author Christopher-Eyk Hrabia
 * 
 */
public class ScreenshotAppState extends AbstractAppState implements
		SceneProcessor {

	private static final Logger logger = Logger
			.getLogger(ScreenshotAppState.class.getName());
	...
	/**
	 * Take a screenshot into defined file
	...
	public void setActionListener(ActionListener readyAction) {
	...
	public Image getLastScreenShot() {
		...
		return awtImage.getScaledInstance(awtImage.getWidth(),
				awtImage.getHeight(), Image.SCALE_FAST);
	}
		...
		if (capture) {
			...
			if (screenShotFile != null) {
				try {
					...
					logger.log(Level.SEVERE, "Error while saving screenshot",
							ex);
				}
			}
			if (readyAction != null) {
