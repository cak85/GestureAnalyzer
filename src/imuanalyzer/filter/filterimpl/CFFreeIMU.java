...
/**
 * Based on Arduino implementation of FreeIMU Library, this code seems to be
 * based on mahony's AHRS filter but it is slightly different
 * http://www.varesano.net/projects/hardware/FreeIMU
 * 
 * @author "Christopher-Eyk Hrabia"
 * 
 */
public class CFFreeIMU extends Filter {
	...
	public String getParameterDescription(int index) {
		switch (index) {
		case 0:
			return "2x Proportional gain governs rate of convergence to accelerometer/magnetometer";
		case 1:
			return "2x Integral gain governs rate of convergence of gyroscope biases";
		default:
			return "";
		}
	}
