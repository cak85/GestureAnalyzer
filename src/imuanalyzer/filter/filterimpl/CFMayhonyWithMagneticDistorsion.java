 ...
 * ======================= Description:
 * 
 * Quaternion implementation of the 'DCM filter' [Mahony et al]. Incorporates
 ...
 * 
 */
public class CFMayhonyWithMagneticDistorsion extends Filter {
	...
	protected static double SamplePeriodFactor = 0.7;
	...
	public CFMayhonyWithMagneticDistorsion() {
		initInteral();
	}
	...
	public String getParameterDescription(int index) {
		...
		case 2:
			return "Division factor for numerical integration. Literature value is 0.5, but slightly higher values could give better results";
		default:
			return "";
		}
	}
